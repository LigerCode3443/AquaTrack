export const signUpText = {
  ...
  ukr: {
    ...
    alreadyHaveAcc: "Вже маєте акаунт?",
    signInLink: "Увійти",
  },
};
...
export const informSectionText = {
  en: {
    ourText: "Our ",
    happyText: "happy ",
    ...
    settingText: "Personal rate setting",
  },
  ukr: {
    ourText: "Наші",
    happyText: "щасливі ",
    ...
    settingText: "Персоналізовані налаштуванння",
  },
};

export const welcomeSectionText = {
  en: {
...
export const settingsText = {
  en: {
    ...
    waterGoalText: "The required amount of water in liters per day:",
  ...
  ukr: {
    ...
    waterGoalText: "Необхідна кількість води в літрах на день:",
